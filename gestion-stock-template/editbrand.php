...
<head>
  ...
  <title>Modifier les marques</title>
      ...
      <div class="content">
        <div class="page-header">
          <div class="page-title">
            <h4>Modifier les marques</h4>
            <h6>Mettez à jour vos marques</h6>
          </div>
        </div>
        <div class="card">
          <div class="card-body">
            <form class="row" method="post" action="editbrand.php" enctype="multipart/form-data">
              ...
              <div class="col-lg-12">
                <button class="btn btn-submit me-2" type="submit" name="update">Mise à jour</button>
