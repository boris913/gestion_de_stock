                            ...
                            <div class="profile-top">
                                ...
                                <div class="ms-auto">
                                    <button class="btn btn-submit me-2" type="submit"
                                        name="submit_image">Mise à jour</button>
                        ...
                        <form class="row" method="post" action="profile.php">
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="+237 676603261"
                            ...
                            <div class="col-12">
                                <button class="btn btn-submit me-2" type="submit" name="submit_data">Mise à jour</button>
